...
class AttendanceForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if teacher.count() > 1 and not any(keyword in subject_name for keyword in ['Practical', 'Project']):
        ...
        if time_slot.count() > 1 and not any(keyword in subject_name for keyword in ['Practical', 'Project']):
        ...
        if time_slot.count() == 1 and any(keyword in subject_name for keyword in ['Practical', 'Project']):
