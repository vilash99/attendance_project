...
urlpatterns = [
    ...
    path('attendances/<int:pk>/',
         AttendanceDetailView.as_view(), name='attendances_detail'),
    path('attendances/new/', AttendanceCreateView.as_view(),
         name='attendances_new'),

    path('entry/new/', EntryCreateView.as_view(), name='entry_new'),
    path('attendances/report/', AttendanceReport.as_view(), name='report'),
    path('attendances/report/<str:class>/',
         AttendanceReport.as_view(), name='report'),
